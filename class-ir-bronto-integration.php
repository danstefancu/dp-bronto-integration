...
class DP_Bronto {
	 ...
	 * @return array
	 */
	function prepare_fields( $user_id ) {
		$fields = array();
	 ...
	 * @return array
	 */
	function prepare_lists( $user_id ) {
		$lists = array();
	 ...
	 */
	function get_contact( $user_data ) {
		$filter = array(
			'email' => array(
				array(
					'operator' => 'EqualTo',
	 ...
	 */
	function add_or_update_contact( $user_data, $old_user_data = '' ) {
	 ...
	 * @param $user_data
	 */
	function delete_contact( $user_data ) {
